# Contributing to search_api_aviasales

We welcome you to [check the existing issues](https://github.com/alinzh/search_api_aviasales/issues) for bugs or enhancements to work on.
If you have an idea for an extension to search_api_aviasales, please [file a new issue](https://github.com/alinzh/search_api_aviasales/issues/new) so we can discuss it.

Make sure to familiarize yourself with the project layout before making any major contributions.

## How to contribute

1. Fork the [project repository](https://github.com/alinzh/search_api_aviasales/): click on the 'Fork' button near the top of the page. This creates a copy of the code under your account on the GitHub server.

2. Clone this copy to your local disk:

   ```bash
   git clone git@github.com:YourUsername/search_api_aviasales.git
   ```
...
Finally, go to the web page of your fork of the search_api_aviasales repo, and click
...
If your contribution changes search_api_aviasales in any way:

- Update the [README](https://github.com/alinzh/search_api_aviasales/tree/master/README.md) if anything there has changed.

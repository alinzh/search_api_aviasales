...
about: Want us to add any features to search_api_aviasales?
title: 'enh: '
labels: enhancement
assignees: ''
...
<!--
  Hi! Thanks for considering to file a feature request with search_api_aviasales. Please take the time to
...
<!--
  Why do you want to see this feature in search_api_aviasales? What use cases does it support?
-->
